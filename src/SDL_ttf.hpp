...
//Prevent name againest from SDL_ttf


#define TTF_Linked_Version __BtkFt__TTF_Linked_Version
#define TTF_ByteSwappedUNICODE __BtkFt__TTF_ByteSwappedUNICODE
#define TTF_Init __BtkFt__TTF_Init
#define TTF_OpenFont __BtkFt__TTF_OpenFont
#define TTF_OpenFontRW __BtkFt__TTF_OpenFontRW
#define TTF_OpenFontIndex __BtkFt__TTF_OpenFontI
#define TTF_OpenFontIndexRW __BtkFt__TTF_OpenFontIRW
#define TTF_GetFontStyle __BtkFt__TTF_GetFontStyle
#define TTF_SetFontStyle __BtkFt__TTF_SetFontStyle
#define TTF_GetFontOutline __BtkFt__TTF_GetFontOutline
#define TTF_SetFontOutline __BtkFt__TTF_SetFontOutline

#define TTF_GetFontHinting _BtkFt__TTF_GetFontHinting
#define TTF_SetFontHinting _BtkFt__TTF_SetFontHinting
#define TTF_FontHeight _BtkFt__TTF_FontHeight
#define TTF_FontAscent _BtkFt__TTF_Ascent
#define TTF_FontDescent _BtkFt__TTF_FontDescent
#define TTF_FontLineSkip _BtkFt__TTF_FontLineSkip
#define TTF_GetFontKerning _BtkFt__TTF_GetFontKerning
#define TTF_SetFontKerning _BtkFt__TTF_SetFontKerning
#define TTF_FontFaces _BtkFt__TTF_FontFaces
#define TTF_FontFaceIsFixedWidth _BtkFt__TTF_FontFaceIsFixedWidth
#define TTF_FontFaceFamilyName _BtkFt__TTF_FontFaceFamilyName
#define TTF_FontFaceStyleName _BtkFt__TTF_FontFaceStyleName
#define TTF_GlyphIsProvided _BtkFt__TTF_GlyphIsProvided
#define TTF_GlyphMetrics _BtkFt__TTF_GlyphMetrics
#define TTF_SizeUTF8 _BtkFt__TTF_SizeUTF8
#define TTF_SizeUNICODE _BtkFt__TTF_SizeUNIC
#define __TTF_FtLibrary _BtkFt__TTF_FtLibrary
